...
def HighRes(mode):
    ...
    # if mode == 'GT':
    # img_folder = '/home/guoshi/data6T/Vivo_Damo/online_videos/Train/'
    # lmdb_save_path = '/home/guoshi/data6T/Vivo_Damo/online_videos/LMDB/HighRes_train_GT.lmdb'
    img_folder = '/home/guoshi/data6T/Vivo_Damo/NewTrainingData/TrainPatches/'
    lmdb_save_path = '/home/guoshi/data6T/Vivo_Damo/NewTrainingData/HighResALL_train_GT.lmdb'
    ...
    all_folder_list = glob.glob(img_folder+'/*')
    folder_length = len(all_folder_list)
    # pdb.set_trace()
    keys = []
    all_img_list = []
    for line in all_folder_list:
        temp = osp.basename(line)
        all_img_list.extend(glob.glob(line+'/*.png'))
        # pdb.set_trace()
        for j in range(9):
            keys.append('{}_{}'.format(temp, j))
    ...
    meta_info['name'] = 'HighResALL_train_GT'
