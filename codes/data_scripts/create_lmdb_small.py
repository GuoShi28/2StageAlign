...
def vimeo90k(mode):
    ...
    # if mode == 'GT':
    img_folder = '/home/guoshi/data6T/Video/vimeo_septuplet/sequences/'
    lmdb_save_path = '/home/guoshi/data6T/Video/Vimeo/vimeo90k_train_GT.lmdb'
    txt_file = '/home/guoshi/data6T/Video/vimeo_septuplet/sep_trainlist.txt'
    H_dst, W_dst = 256, 448
